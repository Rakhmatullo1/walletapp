...
class Home extends StatefulWidget {
  ...
  String args;
  Home(this.args, {Key? key}) : super(key: key);
  @override
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    final userData = Provider.of<UserData>(context, listen: false)
        .data
        .firstWhere((e) => e.id == widget.args);
    Provider.of<Data>(context).fetchAndSetData();
    Provider.of<TransactionData>(context).fetchAndSetData();
                        ...
                        onLongPress: () {
                          showDialog(
                              ...
                              builder: (context) => AlertDialog(
                                    ...
                                    insetPadding: const EdgeInsets.all(192),
                                    contentPadding:
                                        const EdgeInsets.fromLTRB(0, 0, 0, 0),
                                    content: GestureDetector(
                                      onTap: () {
                                        Navigator.of(context).pushNamed(
                                            NewCardScreeen.routeName,
